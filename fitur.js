...
//MESS
        ...
        const isUrl = (url) => {
			...
			const reply = (teks) => {
			Ramdani.sendMessage(from, teks, text, { thumbnail: thumb, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `New Base By Ramdani Official`,body:"© Creator By Aziz Official",previewType:"PHOTO",thumbnail:thumb,sourceUrl:`https://youtube.com/channel/UCB157jomCne961WzYHpG4gg`}}})
		}
		const reply2 = (teks) => {
...
const fdanz = {
	 ...
	 message: { 
		"extendedTextMessage": {
                 "text": `© Creator By Aziz Official`,
                 "title": `© Creator By Aziz Official`,
...
danzrun = process.uptime() 
           Ramdani.setStatus(`${namabot} Aktif Selama ${(danzrun)} © Creator By Aziz Official`).catch((_)=>_); //DI UBAH YATIMM
